...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p><br><br></p>
    <p>This is the Home Page that comes up when you first enter this website.  From this page, you can navigate to pages that will help you log in, register, or contact us.<br><br><br></p>
    ...
    <p><br><br></p>
    <p>Click on either the large button or the tab in the right corner to be directed to the login page.<br><br><br></p>
    <img src="WelcomeRegister.png" alt="Welcome page register" style="width:973px;height:730px;">
    <p><br><br></p>
    
    <p>Click on either the large button or the tab in the right corner to be directed to the page for registration.<br><br><br><br><br></p>
    ...
    <p>This is the login page.  Enter both your email and password, click the check box to be remembered, and click the login button to submit the form. <br><br><br> </p>
   
    <img src="LoginRegister.png" alt="Login register link" style="width:973px;height:730px;">
    <p><br><br></p>
    
    <p>If you do not have an account, please register as a new user with this link.<br><br><br><br><br></p>
    ...
    <p>Use this form to register as a user.  Enter your email, enter your password, type your password again, and enter your name before clicking the button to submit the form.  All of this information is required.  Make sure the password typed is the same in both boxes, otherwise there will be an error. <br><br><br><br><br></p>
    ...
    <p>This is the home page for a patient.  From here, if you are an employee, you can be redirected to view your appointments, manage your password, log off, view your calendar, or schedule an appointment.<br><br><br><br><br></p>
    ...
    <p>This is the home page for an employee of the dental agency.  From here, if you are an employee, you can be redirected to the page to manage your schedule, the page to view your schedule, view your calendar, manage your own password, or log off.<br><br><br><br><br></p>
    ...
    <p>This is the home page for the administrator of the website.  From here you can view the appointments, manage users, manage appointments, log off, or manage your password.<br><br><br><br><br></p>
